    ...
    module Action
        ...
        Vagrant::Action::Builder.new.tap do |b|
          ...
          b.use Call, IsCreated do |env1, b1|
            if env1[:result]
              ...
              # we have to create vm
              env1[:ui].warn 'action_up: we have to create vm'
              b1.use GetNodeList
              b1.use SelectNode
              b1.use Provision
      ...
      def self.action_provision
        Vagrant::Action::Builder.new.tap do |b|
          b.use ConfigValidate
          b.use Call, IsCreated do |env1, b1|
            env1[:ui].warn 'action_provision called'
            if env1[:result]
              b1.use Call, IsStopped do |env2, b2|
                if env2[:result]
      ...
      def self.action_halt
        Vagrant::Action::Builder.new.tap do |b|
          b.use ConfigValidate
          b.use Call, IsCreated do |env1, b1|
            env1[:ui].warn 'action_halt called'
            if env1[:result]
              b1.use Call, IsStopped do |env2, b2|
                if env2[:result]
      ...
      def self.action_destroy
        Vagrant::Action::Builder.new.tap do |b|
          ...
          b.use Call, IsCreated do |env1, b1|
            if env1[:result]
              env1[:ui].warn 'action_destroy called'

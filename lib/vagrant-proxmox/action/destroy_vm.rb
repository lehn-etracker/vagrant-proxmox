  ...
  module Proxmox
    module Action
      ...
      class DestroyVm < ProxmoxAction
        ...
        def call(env)
          env[:ui].info 'DestroyVM will try to destroy VM'
          env[:ui].info I18n.t('vagrant_proxmox.destroying_vm')

          begin
            _node, vm_id = env[:machine].id.split '/'
            ...
            raise VagrantPlugins::Proxmox::Errors::VMDestroyError,
                  proxmox_exit_status: "DestroyVM: #{e.message}"
          end
